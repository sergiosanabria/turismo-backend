 ...
 * DireccionAgenda
 *
 * @ORM\Table(name="direccion_agendas")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\DireccionAgendaRepository")
 * @ExclusionPolicy("all")
 */
class DireccionAgenda
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Agenda", inversedBy="direccion")
